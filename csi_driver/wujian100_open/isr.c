...
extern uint32_t camel_intrpt_enter(void);
extern void camel_intrpt_exit(void);
...
#ifndef CONFIG_KERNEL_NONE
#define  CSI_INTRPT_ENTER()  camel_intrpt_enter()	// wqq // csi_kernel_intrpt_enter()
#define  CSI_INTRPT_EXIT()  camel_intrpt_exit()		// wqq // csi_kernel_intrpt_exit()
#else
#define  CSI_INTRPT_ENTER()  camel_intrpt_enter()	// wqq
#define  CSI_INTRPT_EXIT()  camel_intrpt_exit()		// wqq
#endif
