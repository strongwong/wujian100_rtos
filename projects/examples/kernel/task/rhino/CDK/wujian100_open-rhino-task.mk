...
##
## BuildSet
ProjectName            :=wujian100_open-rhino-task
ConfigurationName      :=BuildSet
WorkspacePath          :=E:/work/T_head/test/projects/examples/kernel/task/rhino/CDK/
ProjectPath            :=E:/work/T_head/test/projects/examples/kernel/task/rhino/CDK/
...
ObjectsFileList        :="wujian100_open-rhino-task.txt"
...
IncludeCPath           :=$(IncludeSwitch)"$(ProjectPath)" $(IncludeSwitch)"$(ProjectPath)../../../../../../board/wujian100_open_evb/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_core/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_driver/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_driver/wujian100_open/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/arch/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/common" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/core/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/pwrmgmt" $(IncludeSwitch)"$(ProjectPath)../../../../../../libs/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../projects/examples/kernel/task/rhino/configs" $(IncludeSwitch)"$(ProjectPath)../../CamelExample/inc" $(IncludeSwitch)"$(ProjectPath)../../CamelRTOS/inc" 
IncludeAPath           :=$(IncludeSwitch)"$(ProjectPath)" -Wa,$(IncludeSwitch)"$(ProjectPath)" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/arch/include" -Wa,$(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/arch/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/common" -Wa,$(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/common" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/core/include" -Wa,$(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/core/include" $(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/pwrmgmt" -Wa,$(IncludeSwitch)"$(ProjectPath)../../../../../../csi_kernel/rhino/pwrmgmt" $(IncludeSwitch)"$(ProjectPath)../../../../../../projects/examples/kernel/task/rhino/configs" -Wa,$(IncludeSwitch)"$(ProjectPath)../../../../../../projects/examples/kernel/task/rhino/configs" $(IncludeSwitch)"$(ProjectPath)../../CamelExample/inc" -Wa,$(IncludeSwitch)"$(ProjectPath)../../CamelExample/inc" $(IncludeSwitch)"$(ProjectPath)../../CamelRTOS/inc" -Wa,$(IncludeSwitch)"$(ProjectPath)../../CamelRTOS/inc" 
IncludePackagePath     :=
...
CXXFLAGS := -mabi=ilp32e -march=rv32emc    -O2  -g3  -Wall -ffunction-sections -fdata-sections 
CFLAGS   := -mabi=ilp32e -march=rv32emc    -O2  -g3  -Wall -ffunction-sections -fdata-sections 
...
Objects0=$(IntermediateDirectory)/wujian100_open_evb_board_init$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_dmac_v2$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_irq$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_pwm$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_rtc$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_usi$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_usi_iic$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_usi_spi$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_usi_usart$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_wj_usi_wrap$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/wujian100_open_system$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_trap_c$(ObjectSuffix) $(IntermediateDirectory)/wujian100_open_vectors$(ObjectSuffix) $(IntermediateDirectory)/CamelRTOS_camel_list$(ObjectSuffix) $(IntermediateDirectory)/CamelRTOS_camel_task$(ObjectSuffix) $(IntermediateDirectory)/CamelExample_CreatList$(ObjectSuffix) $(IntermediateDirectory)/CamelExample_TaskSwitching$(ObjectSuffix) $(IntermediateDirectory)/libc_clock_gettime$(ObjectSuffix) $(IntermediateDirectory)/libc__init$(ObjectSuffix) $(IntermediateDirectory)/libc_malloc$(ObjectSuffix) \
	$(IntermediateDirectory)/libc_minilibc_port$(ObjectSuffix) $(IntermediateDirectory)/mm_dq_addlast$(ObjectSuffix) $(IntermediateDirectory)/mm_dq_rem$(ObjectSuffix) $(IntermediateDirectory)/mm_lib_mallinfo$(ObjectSuffix) $(IntermediateDirectory)/mm_mm_addfreechunk$(ObjectSuffix) $(IntermediateDirectory)/mm_mm_free$(ObjectSuffix) $(IntermediateDirectory)/mm_mm_initialize$(ObjectSuffix) $(IntermediateDirectory)/mm_mm_leak$(ObjectSuffix) $(IntermediateDirectory)/mm_mm_mallinfo$(ObjectSuffix) $(IntermediateDirectory)/mm_mm_malloc$(ObjectSuffix) \
	$(IntermediateDirectory)/mm_mm_size2ndx$(ObjectSuffix) $(IntermediateDirectory)/ringbuffer_ringbuffer$(ObjectSuffix) $(IntermediateDirectory)/syslog_syslog$(ObjectSuffix) 

Objects1=$(IntermediateDirectory)/task_main$(ObjectSuffix) $(IntermediateDirectory)/task_task_test$(ObjectSuffix) $(IntermediateDirectory)/RISC_V_camel_port$(ObjectSuffix) $(IntermediateDirectory)/RISC_V_port_s$(ObjectSuffix) 
...
$(IntermediateDirectory)/CamelRTOS_camel_list$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_list.c  
	@echo compiling camel_list.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_list.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/CamelRTOS_camel_list$(ObjectSuffix) -MF$(IntermediateDirectory)/CamelRTOS_camel_list$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/CamelRTOS_camel_list$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/CamelRTOS_camel_list$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_list.c
	@echo generating preprocess file of camel_list.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/CamelRTOS_camel_list$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_list.c"

$(IntermediateDirectory)/CamelRTOS_camel_task$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_task.c  
	@echo compiling camel_task.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_task.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/CamelRTOS_camel_task$(ObjectSuffix) -MF$(IntermediateDirectory)/CamelRTOS_camel_task$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/CamelRTOS_camel_task$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/CamelRTOS_camel_task$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_task.c
	@echo generating preprocess file of camel_task.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/CamelRTOS_camel_task$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/camel_task.c"

$(IntermediateDirectory)/CamelExample_CreatList$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelExample/CreatList.c  
	@echo compiling CreatList.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/CamelExample/CreatList.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/CamelExample_CreatList$(ObjectSuffix) -MF$(IntermediateDirectory)/CamelExample_CreatList$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/CamelExample_CreatList$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/CamelExample_CreatList$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelExample/CreatList.c
	@echo generating preprocess file of CreatList.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/CamelExample_CreatList$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/CamelExample/CreatList.c"

$(IntermediateDirectory)/CamelExample_TaskSwitching$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelExample/TaskSwitching.c  
	@echo compiling TaskSwitching.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/CamelExample/TaskSwitching.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/CamelExample_TaskSwitching$(ObjectSuffix) -MF$(IntermediateDirectory)/CamelExample_TaskSwitching$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/CamelExample_TaskSwitching$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/CamelExample_TaskSwitching$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelExample/TaskSwitching.c
	@echo generating preprocess file of TaskSwitching.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/CamelExample_TaskSwitching$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/CamelExample/TaskSwitching.c"
...
$(IntermediateDirectory)/task_main$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/main.c  
	@echo compiling main.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/main.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/task_main$(ObjectSuffix) -MF$(IntermediateDirectory)/task_main$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/task_main$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/task_main$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/main.c
	@echo generating preprocess file of main.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/task_main$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/main.c"

$(IntermediateDirectory)/task_task_test$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/task_test.c  
	@echo compiling task_test.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/task_test.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/task_task_test$(ObjectSuffix) -MF$(IntermediateDirectory)/task_task_test$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/task_task_test$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/task_task_test$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/task_test.c
	@echo generating preprocess file of task_test.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/task_task_test$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/task_test.c"

$(IntermediateDirectory)/RISC_V_camel_port$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/camel_port.c  
	@echo compiling camel_port.c...
	@$(CC) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/camel_port.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/RISC_V_camel_port$(ObjectSuffix) -MF$(IntermediateDirectory)/RISC_V_camel_port$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/RISC_V_camel_port$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/RISC_V_camel_port$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/camel_port.c
	@echo generating preprocess file of camel_port.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/RISC_V_camel_port$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/camel_port.c"

$(IntermediateDirectory)/RISC_V_port_s$(ObjectSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/port_s.S  
	@echo assembling port_s.S...
	@$(AS) $(SourceSwitch) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/port_s.S" $(ASFLAGS) -MMD -MP -MT$(IntermediateDirectory)/RISC_V_port_s$(ObjectSuffix) -MF$(IntermediateDirectory)/RISC_V_port_s$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/RISC_V_port_s$(ObjectSuffix) $(IncludeAPath) $(IncludePackagePath)
Lst/RISC_V_port_s$(PreprocessSuffix): E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/port_s.S
	@echo generating preprocess file of port_s.S...
	@$(CC) $(CFLAGS)$(IncludeAPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/RISC_V_port_s$(PreprocessSuffix) "E:/work/T_head/test/projects/examples/kernel/task/CamelRTOS/portable/RVDS/RISC_V/port_s.S"
...
clean:
	...
	@rm -rf $(IntermediateDirectory)/ $(ObjectsFileList) wujian100_open-rhino-task.mk Lst/
